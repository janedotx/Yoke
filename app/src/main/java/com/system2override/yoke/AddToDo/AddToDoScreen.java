package com.system2override.yoke.AddToDo;
...
public class AddToDoScreen extends AppCompatActivity {
...
//        /*
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MyApplication.getDb(AddToDoScreen.this).habitDao().insert(habit);
                GeneralDebugging.printDb(MyApplication.getDb(AddToDoScreen.this));
                AddToDoScreen.this.bus.post(new ToDoCreated());

                Intent i = new Intent(AddToDoScreen.this, TodoManagementScreen.class);
                startActivity(i);
            }
        });
